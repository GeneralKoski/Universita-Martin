...
In tutto le previsioni sono 115: 77 confermate, 28 smentite, 7 a metà, e 3 senza
un esito registrato (la quarta della prima misura del baseline, la settima della
voce E1 e la quarta di \texttt{costo-vettori}). Delle 112 con un esito, quasi
una su tre non ha tenuto del tutto. La prima di \texttt{contesto-ollama},
