...
parti, con un vettore per parte. Per questa tesi la questione, oggi, non si pone:
Documentale indicizza le schede, che sono brevi, e anche il testo integrale degli
atti di Crispiano, fra i 5 e i 13 mila caratteri, sta secondo una stima nell'ordine
di qualche migliaio di token, sotto il contesto di \texttt{bge-m3}. Se spezzare
convenga comunque, per la pertinenza e non per il limite del modello, lo dirà la
misura della scheda contro il testo intero (sezione~\ref{sec:scheda-testo}), che
aspetta le query known-item scritte da persone.
