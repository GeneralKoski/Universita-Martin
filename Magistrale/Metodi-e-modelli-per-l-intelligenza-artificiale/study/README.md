...
- I PDF in `Elly/` sono il **programma ufficiale 2025/2026** (6 CFU). Quello è il riferimento.
- Gli appunti in `Appunti_colleghi/` sono dei gestionali (9 CFU, mutuato): più estesi del necessario, **usali come approfondimento**, non come base.
