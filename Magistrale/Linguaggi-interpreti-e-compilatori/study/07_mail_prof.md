...
**A:** `enea.zaffanella@unipr.it`
**Oggetto:** Assenza all'appello del 10 settembre - Linguaggi, Interpreti e Compilatori
...
### Perché la seconda domanda conta

È la parte che vale davvero: il seminario pesa il **30%** del voto ed è già in cassaforte *per l'a.a. 2025/26*. L'appello di settembre 2026 è con ogni probabilità l'ultimo di quell'anno accademico, quindi la risposta del prof decide se il rinvio costa solo tempo di studio o anche un seminario nuovo da preparare. Va chiesta ora, non a gennaio: se serve rifarlo, l'argomento va concordato **almeno 30 giorni prima** dell'appello invernale.

## Date confermate

- **Seminario:** martedì **23 giugno 2026, ore 12:30** (dopo lo scritto di Metodologie) - ✅ **svolto**. Vale per tutti gli appelli dell'a.a. 2025/26; validità oltre quell'a.a. da accertare.
- **Orale LIC:** giovedì **10 settembre 2026** - 🛑 **non sostenuto** (il 26 agosto era l'altra opzione, scartata).
- **Prossimo appello:** sessione invernale (gennaio-febbraio 2027), data da verificare su Esse3.

## Scambio mail (riassunto)

- 2026-05-13 - proposta finestra 29 giu - 5 lug
- 2026-05-15 - prof propone settimana prima (22-24 giu) o dopo (7-9 lug)
- 2026-05-15 - confermato 23 giu pomeriggio
...
- [ ] **Mandare la mail sopra** (entro l'8 settembre)
- [ ] Registrare qui la risposta del prof sulla validità del seminario
- [ ] Verificare su Esse3 la data dell'appello invernale appena esce il calendario
- [ ] Se il seminario va rifatto: scrivere al prof per concordare argomento e materiale, con ≥30 giorni di margine sull'appello
