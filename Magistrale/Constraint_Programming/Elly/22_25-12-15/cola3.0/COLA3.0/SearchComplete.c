...
void search_complete(int lev) {
    ...
    if (SEARCH_DBG)
        printf("Selected var %d on lev %d\n", variable, lev);
        ...
        /// normal indomain
        {
            if (choice[0] == -1)
                ...
                while (!done) {
                    ...
                    } else if ((choice[0] + choice[1] + choice[2]) % 2 == 0)
                        done = 1;
                }
            }
        } else
                        ...
                        if (ct == 1) /// first time the block is labelled
                        {
                            ...
                            for (int h = 0; h < 24; h++) {
                                ...
                                if (flag1 && cstore_ac(STATE, trailtop)) /// arc consistency on non ground vars
                                {
                                    ...
                                    //            printf("\n");
                                    search_complete(lev + n_var); /// proceed in tree exploration
                                }
